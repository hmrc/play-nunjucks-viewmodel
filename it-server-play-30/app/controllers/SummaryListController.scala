      ...
      List(
        SummaryList.Row(
          ...
          value = SummaryList.Value(
            getFromSession[RadioAnswer]("radios")
              .map(value => msg"radios.${value.toString.toLowerCase}")
              .getOrElse(msg"site.na")
          ),
          actions = List(
            SummaryList.Action(
              msg"site.edit",
        ...
        SummaryList.Row(
          ...
          value =
            SummaryList.Value(if (getFromSession[Boolean]("yesNo").contains(true)) msg"site.yes" else msg"site.no"),
          actions = List(
            SummaryList.Action(
              msg"site.edit",
